 ...
 * RocketMQSourceSplit}.
 *
 * @see OffsetsSelectorByStrategy
 * @see OffsetsSelectorBySpecified
 * @see OffsetsSelectorByTimestamp
 */
@PublicEvolving
public interface OffsetsSelector extends Serializable {
    ...
    /**
     * An interface that provides necessary information to the {@link OffsetsSelector} to get
    ...
    /**
     * Get an {@link OffsetsSelector} which initializes the offsets to the committed offsets.
     ...
     *                            exist.
     * @return an {@link OffsetsSelector} which initializes the offsets to the committed
     * offsets.
     */
    ...
    /**
     * Get an {@link OffsetsSelector} which initializes the offsets in each partition so that
     * the
     ...
     *
     * @return an {@link OffsetsSelector} which initializes the offsets to the earliest
     * available offsets.
     */
    ...
    /**
     * Get an {@link OffsetsSelector} which initializes the offsets to the latest offsets of
     * each partition.
     *
     ...
     * @return an {@link OffsetsSelector} which initializes the offsets to the specified
     * offsets.
     */
     ...
     * offsets.
     */
    static OffsetsSelector offsets(Map<MessageQueue, Long> offsets, OffsetResetStrategy offsetResetStrategy) {
